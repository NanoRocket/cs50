...
// If your program is executed with fewer or more than two command-line arguments, it should 
...
// Your program should accept exactly two command-line arguments: the name of an input file to 
// open for reading followed by the name of an output file to open for writing.    
    // remember filenames
    char *infile = argv[1];
    char *outfile = argv[2];
...
// as with fprintf (to stderr), and main should return 4.
    ...
    for (int i = 0, biHeight = abs(bi.biHeight); i < biHeight; i++)
    {
        ...
        for (int j = 0; j < bi.biWidth; j++)
        {
            ...
            // make the really red pixels black
